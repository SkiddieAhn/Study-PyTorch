...
class MyNetG(nn.Module):
    """
    CUSTOM GENERATOR NETWORK
    """

    def __init__(self):
        super(MyNetG, self).__init__()
        self.encoder1 = Encoder(64, 100, 3, 64, 1, 0)
        self.decoder = Decoder(64, 100, 3, 64, 1, 0)
        self.encoder2 = Encoder(64, 100, 3, 64, 1, 0)
