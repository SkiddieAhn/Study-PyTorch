...
class Visualizer():
    ...
    def save_current_images_test(self, real, fake, idx):
        vutils.save_image(real, 'output/ganomaly/custom_ucsd/test/images/reals/'+str(idx)+'.png', normalize=True)
        vutils.save_image(fake, 'output/ganomaly/custom_ucsd/test/images/fakes/'+str(idx)+'.png', normalize=True)