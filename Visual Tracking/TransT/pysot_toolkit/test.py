...
def main():
    # load config
    dataset_root = '/home/seinkwon/ahnsunghyun/dataset/GOT-10k/test/' #Absolute path of the dataset
    net_path = '/home/seinkwon/ahnsunghyun/TransT2/checkpoints/checkpoints/ltr/transt/transt' #Absolute path of the model
